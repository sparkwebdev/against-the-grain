[![Netlify Status](https://api.netlify.com/api/v1/badges/bbf28a84-4bdb-407b-a2fa-32628d27fa3d/deploy-status)](https://app.netlify.com/sites/against-the-grain/deploys)
...
🔥 **This project is featured on Netlify's official [template showcase](https://templates.netlify.com/templatagainst-the-grainte/)** 🔥

## [Demo Site](https://against-the-grain.netlify.com//)
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/sparkwebdev/against-the-grain&stack=cms)
...
```
git clone https://github.com/sparkwebdev/against-the-grain.git my-blog-name
```
